    ...
    const initAnimation = (): void => {
        ...
        ctx = gsap.context(() => {
            ...
            if (window.outerWidth > 850) {
                ...
                .to(`.${classesHeader['scale-container']}`, {duration: 1.5, rotate: -1, x: -155 * vw, y: YScaleContainer2, ease: 'linear'}, 'header-animation-2')
                .to(`.${classesHeader['appearing-info']}`, {duration: .4, x: -40 * vw + -50 * baseFontSize, y: 15 * vh, autoAlpha: 0, ease: 'linear'}, 'header-animation-2')
                .to(`.${classesHeader['character-4']}`, {duration: .4, y: 4 * vh, ease: 'linear'}, 'header-animation-2')
                .to(`.${classesHeader['scale-container']}`, {duration: .8, delay: 1.5, scale: 4.1, x: -150 * vw, y: YScaleContainer2 + -4 * vh, ease: 'linear'}, 'header-animation-2')
                .from(`.${classesHeader['appearing-info-2']}`, {duration: .8, delay: 1.5, y: -5 * vh, autoAlpha: 0, ease: 'linear'}, 'header-animation-2')
                .add('header-animation-3')
                .to(`.${classesHeader['inner-container']}`, {duration: .4, autoAlpha: 0, ease: 'linear'}, 'header-animation-3')
                .to(`.${classesHeader['appearing-info-2']}`, {duration: .7, x: 20 * vw + 40 * baseFontSize, y: -15 * vh, autoAlpha: 0, ease: 'linear'}, 'header-animation-3')
                .to(`.${classesHeader['scale-container']}`, {duration: 1.5, rotate: 0, x: 0, y: 0, ease: 'linear'}, 'header-animation-3')
                .to(`.${classesHeader['scale-container']}`, {duration: 1.5, delay: 1.5, scale: 1, ease: 'linear'}, 'header-animation-3')
                .from(`.${classesHeader['cloud-left-last']}`, {duration: 1.5, delay: 1.5, opacity: 0, ease: 'linear'}, 'header-animation-3')
                .from(`.${classesHeader['cloud-right-last']}`, {duration: 1.5, delay: 1.5, opacity: 0, ease: 'linear'}, 'header-animation-3')
                .from(`.${classesHeader['appearing-info-3']}`, {duration: .9, delay: .8, autoAlpha: 0, ease: 'linear'}, 'header-animation-3')
                ...
                .to(`.${classesSectionForest['grass-container']}`, {duration: 1, scale: 2.1, x: -130 * vw, y: -9 * 8, ease: 'linear'}, 'section-forest-animation-5')
